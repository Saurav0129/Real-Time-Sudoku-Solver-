...
if selected_page == "Sudoku Solver":
    ...
    st.title("About Sudoku Solver App :pencil:")
    st.write("""
    ...
    ### Features :sparkles:
    - Upload an image of a Sudoku puzzle :camera:
    - Automatically solve the puzzle with a deep learning model :robot:
    - Download the solved puzzle image :floppy_disk:
    """)
    
    st.markdown("### GitHub Repository :link:")
    github_link = "https://github.com/Saurav0129/Real-Time-Sudoku-Solver-"
    st.markdown(
        f"Check out the [GitHub repository]({github_link}) for more details and to access the source code. :octocat:"
    )
